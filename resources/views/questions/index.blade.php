...
<x-app-layout>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-8">
        <form action="{{ route('questions.search') }}" method="GET" class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
                <div class="relative">
                ...
                <div class="flex justify-between items-start mb-3">
                   ...
                   <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600 hover:text-blue-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 4h2m1 0h2m4 3a2.5 2.5 0 00-5 0m-5 4L4 19l-1 4 4-1 9-9m-1-3a2.5 2.5 0 115 0" />
                        ...
                        {{-- @endif --}}
                        <form action="{{ route('questions.favori', $question->id) }}" method="POST"  class="inline-block">
                            @csrf   
                            <button type="submit"  class="favorite-btn text-gray-400 hover:text-yellow-500 transition-colors" >
...
function getUserLocation() {
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            document.getElementById("current-location").textContent = `Latitude: ${lat}, Longitude: ${lon}`;
        }, function(error) {
